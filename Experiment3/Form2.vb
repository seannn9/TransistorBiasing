...
Public Class Form2
    ...
    Dim table_name As New String("emitter")
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Try
            ...
            ElseIf String.IsNullOrEmpty(ComboBox1.Text) Or
                   ...
                   String.IsNullOrEmpty(ComboBox3.Text) Or
            ...
            Else
                ...
                cmd.Parameters.AddWithValue("@VRE", f_Vre)
                ...
                End If
                ' Reset all state after successfully adding record
                TextBox2.Clear()
                TextBox1.Clear()
                TextBox3.Clear()
                TextBox4.Clear()
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        Try
            ...
            Else
                ...
                Dim Re As Double = Convert.ToDouble(TextBox3.Text)
                ...
                If ComboBox3.Text = "Ω" Then
                    Re = Re
                    _Re.Text = Re & ComboBox3.Text
                ElseIf ComboBox3.Text = "kΩ" Then
                    Re = Re * 1000
                    _Re.Text = (Re / 1000) & ComboBox3.Text
                Else
                    Re = Re * 1000000
                    _Re.Text = (Re / 1000000) & ComboBox3.Text
                End If
                ...
                If Vre < 0.001 Then
                    f_Vre = Math.Round((Vre * 1000000), 2) & " µV"
                    Me.Vre.Text = "Vre = " & f_Vre
                ElseIf Vre < 1 Then
                    f_Vre = Math.Round((Vre * 1000), 2) & " mV"
                    Me.Vre.Text = "Vre = " & f_Vre
                Else
                    f_Vre = Math.Round(Vre, 2) & " V"
                    Me.Vre.Text = "Vre = " & f_Vre
                End If
